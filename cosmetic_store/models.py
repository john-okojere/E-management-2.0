...
class Day(models.Model):
    staff = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='beauty_days')
...
class Inventory(models.Model):
    staff = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='beauty_inventories')
...
class Sale(models.Model):
    cashier = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name="beauty_sale")  # Who handled the sale
...
class SaleItem(models.Model):
    sale = models.ForeignKey(Sale, on_delete=models.CASCADE, related_name="beauty_items")  # Reference to the sale
...
class SaleDiscount(models.Model):
    cashier = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='beauty_discounts')
    sale = models.ForeignKey(Sale, on_delete=models.CASCADE, related_name='beauty_discounts')
    proposed_discount = models.DecimalField(max_digits=10, decimal_places=2)
    approved = models.BooleanField(default=False)
    approved_by = models.ForeignKey(CustomUser, on_delete=models.SET_NULL, null=True, blank=True, related_name='beauty_approver')

class SaleItemDiscount(models.Model):
    cashier = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='beauty_saleitem_discounts')
    sale = models.ForeignKey(SaleItem, on_delete=models.CASCADE, related_name='beauty_discounts')
    proposed_discount = models.DecimalField(max_digits=10, decimal_places=2)
    approved = models.BooleanField(default=False)
    approved_by = models.ForeignKey(CustomUser, on_delete=models.SET_NULL, null=True, blank=True, related_name='beauty_saleitem_approver')
...
class Payment(models.Model):
    ...
    sale = models.ForeignKey(Sale, on_delete=models.CASCADE, related_name='beauty_payments')
    cashier = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='beauty_cashier_payments')
...
class Refund(models.Model):
    sale = models.ForeignKey(Sale, on_delete=models.CASCADE, related_name="beauty_refunds")
    amount = models.DecimalField(max_digits=100, decimal_places=2)
    refunded_by = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='beauty_refunded_by')
    date = models.DateTimeField(auto_now_add=True)
