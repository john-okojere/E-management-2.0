...
def start_day(request):
    ...
    return render(request, 'salon/start_day.html', {'form': form})
...
def cashier(request):
    ...
    if not unfinished_day:
        return redirect('salon_start_day')  # Redirect to the start day view if no day has started
...
def add_inventory(request):
    ...
    try:
        ...
        return redirect('salon_inventory_list')
    ...
    return render(request, 'salon/inventory/add.html', {'form': form})
...
def inventory_list(request):
    ...
    return render(request, 'salon/inventory/list.html', {'items': items})
...
def update_inventory(request, pk):
    ...
    return render(request, 'salon/inventory/update_inventory.html', {'form': form})
...
def delete_inventory(request, pk):
    ...
    if request.method == "POST":
        ...
        return redirect('salon_inventory_list')
    return render(request, 'salon/inventory/delete_inventory.html', {'item': item})
...
def sales_history(request):
    ...
    return render(request, 'salon/sales_history.html', {
        'sales': sales_data,
...
def end_of_day_report(request):
    ...
    return render(request, 'salon/end-of-day.html', {'report': report})
...
def end_day(request):
    ...
    unfinished_day.save()
    return redirect('salon_end_of_day_report')  # Redirect to the start day view if no day has started
...
def audit_report(request):
    ...
    return render(request, "salon/audit_report.html", context)